            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-5">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" name="calories" value={formData.calories} onChange={handleChange} placeholder="e.g. ~380 kcal" className="form-input" />
                </div>
                <div>
                  <label className="form-label">Prep Time</label>
                  <input type="text" name="prepTime" value={formData.prepTime} onChange={handleChange} placeholder="e.g. 25 min" className="form-input" />
                </div>
                <div>
                  <label className="form-label">Servings</label>
                  <input type="text" name="servings" value={formData.servings} onChange={handleChange} placeholder="e.g. 1-2" className="form-input" />
                </div>
              </div>

              <div>
                <label className="form-label">Dietary Tags <span className="text-gray-400 font-normal">(comma separated)</span></label>
                <input type="text" name="dietaryTags" value={formData.dietaryTags} onChange={handleChange} placeholder="e.g. Vegan, Gluten-Free, Chef Recommended" className="form-input" />
              </div>
            </div>
          </div>
